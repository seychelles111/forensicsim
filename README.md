...
A wee script for populating *Microsoft Teams 2.0* in a lab environment. The script can be used like this:

```
utils\populate_teams_2.py -a 0 -f conversation.json
```
